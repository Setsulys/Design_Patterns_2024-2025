...
class_providing_the_interface="com.evilcorp.CoolGraphics"
included_classes=("com.evilcorp.CoolGraphics" "fr.uge.poo.ducks.RegularDuck" "$interface_provided" "$class_providing_the_interface")
